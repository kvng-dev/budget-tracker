...
const ManagePage = () => {
  return (
    <div>
      ...
      <div className="container flex flex-col gap-4 py-4 mx-auto max-w-7xl">
...
function CategoryList({ type }: { type: TransactionType }) {
  ...
  const dataAvailable = categoryQuery.data && categoryQuery.data.length;
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-2">
            ...
            <CreateCategoryDialog
              type={type}
              onSuccessCb={() => categoryQuery.refetch()}
              trigger={
